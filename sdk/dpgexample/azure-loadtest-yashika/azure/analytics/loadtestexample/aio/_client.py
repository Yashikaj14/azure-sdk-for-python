...
class LoadTestClient:
    ...
    :vartype app_component: azure.analytics.loadtestexample.aio.operations.AppComponentOperations
    :ivar server_metrics: ServerMetricsOperations operations
    :vartype server_metrics: azure.analytics.loadtestexample.aio.operations.ServerMetricsOperations
    :ivar test: TestOperations operations
    :vartype test: azure.analytics.loadtestexample.aio.operations.TestOperations
    :ivar test_run: TestRunOperations operations
    :vartype test_run: azure.analytics.loadtestexample.aio.operations.TestRunOperations
