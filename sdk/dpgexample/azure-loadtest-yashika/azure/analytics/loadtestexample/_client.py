...
class LoadTestClient:
    ...
    :vartype app_component: azure.analytics.loadtestexample.operations.AppComponentOperations
    :ivar server_metrics: ServerMetricsOperations operations
    :vartype server_metrics: azure.analytics.loadtestexample.operations.ServerMetricsOperations
    :ivar test: TestOperations operations
    :vartype test: azure.analytics.loadtestexample.operations.TestOperations
    :ivar test_run: TestRunOperations operations
    :vartype test_run: azure.analytics.loadtestexample.operations.TestRunOperations
